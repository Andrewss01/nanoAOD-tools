...
usage = 'python3 Training_MC_2.py -s TT,ZJ1,ZJ2 -i /eos/user/a/apuglia/SWAN_projects/thesis/CMSSW_14_1_7/src/training_dataset/trainingSet_10k.pkl -m ./models/model.h5 -j ./scores.json -g ./grafiche -v True -o True'
...
if not os.path.exists(path_to_model_folder + "/best_hps_jets_fatjets_2.json"):
...
#tuner.get_best_hyperparameters(num_trials=1)
    ...
    path_to_hps = "/eos/user/l/lfavilla/xAndreaCP/best_hps.json"
    with open(path_to_hps ) as f:
