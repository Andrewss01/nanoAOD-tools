...
select_trs= True
select_best_top= False

folderIn= "/eos/user/a/apuglia/SWAN_projects/thesis/CMSSW_14_1_7/src/"

datasets = ['TT', 'ZJ1', 'ZJ2' ]
infile = {datasets[0]: "TT_Skim.root", datasets[1]: 'ZJ_1_Skim.root', datasets[2]: 'ZJ_2_Skim.root'}
...
trs1 = trs['fpr 1']
trs01 = trs['fpr 01']
print('tresholds at 10: ', trs10, ' tresholds at 1: ', trs1,' treshold at 0.1: ', trs01)
...
outfile = open("/eos/user/a/apuglia/SWAN_projects/thesis/CMSSW_14_1_7/src/training_dataset/trainingset_TT.pkl", "wb")
...
plt.savefig("/eos/user/a/apuglia/SWAN_projects/thesis/CMSSW_14_1_7/src/training_dataset/Ntopperevent_TT.png")
fig, ax = plt.subplots()
...
ax.set_xlabel("# top per event")
ax.legend()
plt.savefig("/eos/user/a/apuglia/SWAN_projects/thesis/CMSSW_14_1_7/src/training_dataset/Ntopcategoryperevent_TT.png")
