...
parser.add_option('-f'  , '--file'   , dest='file'  , type=str   , default="/eos/user/a/apuglia/TROTA/Study_pt_distribution/histos/pt_topmixed_sig_bkg.root"   )
...
histo_sig = ROOT.TH1F('pT_'+main_sample.label+'_true_tops', 'pT_'+main_sample.label+'_true_tops',200,0,1000)
histo_bkg = ROOT.TH1F('pT_'+main_sample.label+'_false_tops', 'pT_'+main_sample.label+'_false_tops',200,0,1000)
