...
best_hps_file = '/afs/cern.ch/user/a/apuglia/CMSSW_14_1_7/src/PhysicsTools/NanoAODTools/python/postprocessing/TROTA_2D_2022/final_trainings/training_pfsv_cnn_Mixed_'+label+'/best_hps_'+label+'.json'
# best_hps_file = 
...
trainer1.model_builder(trainer1.X_fatjet_train.shape[1], trainer1.X_jet_train.shape[2], trainer1.X_top_train.shape[1], trainer1.X_pfc_train.shape[2])
