...
#models["TopMixed_2018"]         = tf.keras.models.load_model(path_to_model_folder+TopMixed2018, custom_objects={'Orthogonal': initializers.Orthogonal})
...
class nanoTopevaluate_MultiScore(Module):
    ...
    def analyze(self, event):
        ...
        mass_dnn    = np.zeros((len(tophighpt), 5))
