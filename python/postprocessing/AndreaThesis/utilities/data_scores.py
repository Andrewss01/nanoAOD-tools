...
file = ROOT.TFile.Open('/eos/user/a/apuglia/thesis/Datasets/Dati_14_05_2025_Scores/tree_hadd_23_Scores.root', 'READ')
...
for i in range(tree.GetEntries()):
    ...
    for top in tops: 
        score_1 = top.TTScore/(top.FTScore + top.TTScore)
...
histo_2.SetLineColor(ROOT.kRed)
histo_1.SetLineColor(ROOT.kBlue)
