...
path_to_training_folder = '/eos/user/a/apuglia/Master_Thesis/pkls'

path_to_pkl_folder          = "{}/training_dataset_reduced".format(path_to_training_folder)
dataset                     = {}
...
concName             = "training_dataset_1.pkl"
