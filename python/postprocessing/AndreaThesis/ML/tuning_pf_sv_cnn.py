...
class trainer:
    ...
    def tune_hps(self, project_name, max_epochs, batch_size, factor =3):
        ...
        tuner.search({'fatjet': self.X_fatjet_train, 'jet': self.X_jet_train, 'top': self.X_top_train, 'pfc': self.X_pfc_train, 'sv': self.X_sv_train}, 
...
trainer1.tune_hps(project_name = 'tuning_cnn_'+label, max_epochs= 1000, batch_size = 250)
