...
class trainer: 
    def __init__(self, X_jet, X_fatjet, X_top, y, best_hyperparameters):
        self.X_jet = X_jet
    ...
    def callbacks(self): 
        ...
        reduce_LR = keras.callbacks.ReduceLROnPlateau(monitor="val_accuracy",
                                                      ...
                                                      min_lr=1e-15) 
        self.callbacks_list = [early_stop, reduce_LR]
    ...
    def training(self, validation_split, epochs, batch_size, save_model = True, path_to_model = outModel ):
        # if self.model == None and self.best_hps == None:
        ...
        # self.model = self.load_model('/afs/cern.ch/user/a/apuglia/CMSSW_14_1_7/src/PhysicsTools/NanoAODTools/python/postprocessing/AndreaThesis/trainings/model_28_04_2025/model_28_04_2025.h5')
        print('model is: ', self.model)
        #print('best hps is: ', self.best_hps)
        ...
        # print('model summary: ', self.model.summ
        # ary())
        if save_model:
...
# best_hps_file = '/eos/user/l/lfavilla/xAndreaCP/best_hps.js
# best_hps_file = 'afs/cern.ch/user/a/apuglia/PhysicsTools/NanoAODTools/python/postprocessing/AndreaThesis/ML/model_26_04_2025/model_26_04_2025.h5'
# # trainer1.tune_hps(project_name= 'prova', max_epochs = 1000, batch_size= 250)
training, tuning = True, False 
if training:

    best_hps_file = '/afs/cern.ch/user/a/apuglia/CMSSW_14_1_7/src/PhysicsTools/NanoAODTools/python/postprocessing/AndreaThesis/trainings/training_29_04_2025/best_hps_29_04_2025.json'
    with open(best_hps_file) as hps_file:
        best_hyperparams= json.load(hps_file)

        print('best hps are: ', best_hyperparams)
    ...
    # print('model summary: ', trainer1.model_summary())
    ...
    with open(f"{path_graphics}/best_hps_05_05_2025.json", "w") as jsFile:
        json.dump(best_hyperparams, jsFile, indent=4)
if tuning: 
    trainer1 = trainer(*data)
    trainer1.split(test_size= 0.3)
    trainer1.tune_hps(project_name= 'tuning_28_04_2025', max_epochs= 1000, batch_size= 250)
    print('model is: ', trainer1.model)
    trainer1.training(validation_split= 0.3, epochs= 1000, batch_size= 250)
    best_hyperparams = trainer1.best_hps
    print(f"BEST HPS FOUND:\n{best_hyperparams}")
    with open(f"{path_graphics}/best_hps_30_04_2025.json", "w") as jsFile:
        json.dump(best_hyperparams, jsFile, indent=4)
