...
best_hps_file = '/afs/cern.ch/user/a/apuglia/CMSSW_14_1_7/src/PhysicsTools/NanoAODTools/python/postprocessing/AndreaThesis/final_trainings/tuning_resolved_'+label+'/best_hps_'+label+'.json'
...
trainer1.model_builder(trainer1.X_jet_train.shape[2], trainer1.X_top_train.shape[1], trainer1.X_pfc_train.shape[2], trainer1.X_sv_train.shape[2])
