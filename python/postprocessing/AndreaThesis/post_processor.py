...
if create_file_select:
    p=PostProcessor("/eos/user/a/apuglia/thesis/Datasets/",fnames,branchsel=None,modules=[GenPart_MomFirstCp(flavour = '-5,-4,-3,-2,-1,1,2,3,4,5,6,-6,24,-24'), Idx_PFC_SV(), deltaR_PF_SV(),
                    ...
                    ,histFileName="histOut"+label+".root",histDirName="plots", postfix = '_Skim', outputbranchsel="%s/src/PhysicsTools/NanoAODTools/scripts/keep_and_drop_jets_pf_sv.txt" % os.environ["CMSSW_BASE"], maxEntries = 10000)
    p.run()
