...
class trainer:
    ...
    def model_builder(self, hp):
        ...
        x = Dense(units = fj_units, activation =  fj_activation, kernel_initializer = 'random_uniform')(x)
...
trainer1.split(0.3)
trainer1.tune_hps(max_epochs= 1000, batch_size = 250)
